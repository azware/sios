    ...
    <div class="col-12">
        ...
        <form action="/siswa/create" method="post" class="needs-validation" novalidate>
            ...
            <div class="form-group">
                ...
                <textarea name="alamat" id="alamat" class="form-control" required><?= set_value('alamat') ?></textarea>
                <div class="invalid-feedback">Alamat wajib diisi.</div>
            </div>
            <div class="form-group">
                <label for="tanggal_lahir">Tanggal Lahir:</label>
                <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control" value="<?= set_value('tanggal_lahir') ?>" required>
            ...
            <div class="form-group">
                ...
                <textarea name="informasi_keluarga" id="informasi_keluarga" class="form-control"><?= set_value('informasi_keluarga') ?></textarea>
            </div>
            <div class="form-group">
                <label for="sekolah_sebelumnya">Sekolah Sebelumnya:</label>
                <input type="text" name="sekolah_sebelumnya" id="sekolah_sebelumnya" class="form-control" value="<?= set_value('sekolah_sebelumnya') ?>">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" name="nomor_telepon" id="nomor_telepon" class="form-control" value="<?= set_value('nomor_telepon') ?>" required>
                <div class="invalid-feedback">Nomor telepon wajib diisi.</div>
            </div>
            <div class="form-group">
                <label for="foto">Foto:</label>
                <input type="text" name="foto" id="foto" class="form-control" value="<?= set_value('foto') ?>">
            </div>
